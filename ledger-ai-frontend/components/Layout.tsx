...
const Layout: React.FC<LayoutProps> = ({ children }) => {
  ...
  return (
    <div className="min-h-screen bg-zinc-50 flex font-inter text-zinc-900">
      ...
      `}>
        <div className="h-full flex flex-col">
          <div className="p-6 border-b border-zinc-100 flex items-center justify-between">
            ...
            <button className="lg:hidden text-zinc-500 hover:text-black" onClick={() => setSidebarOpen(false)}>
              <X size={24} />
            </button>
          </div>
          ...
          <div className="p-4 border-t border-zinc-100">
            <button
              ...
              className="flex items-center gap-3 px-4 py-3 w-full rounded-xl text-zinc-500 hover:bg-red-50 hover:text-red-600"
            >
      ...
      <main className="flex-1 flex flex-col min-h-screen">
        {/* Mobile Header */}
        <header className="lg:hidden h-16 bg-white border-b border-zinc-200 flex items-center justify-between px-4 sticky top-0 z-30">
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 bg-black rounded-lg flex items-center justify-center">
              <span className="text-white font-bold text-lg">L</span>
            </div>
          ...
          <button onClick={() => setSidebarOpen(true)} className="p-2 hover:bg-zinc-100 rounded-lg">
            <Menu size={24} />
          </button>
        </header>
